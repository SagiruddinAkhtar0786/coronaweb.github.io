     ...
     if($_SERVER["REQUEST_METHOD"] == "POST"){
         ...
         $newpassword = $_POST["newpassword"];
          $psw = md5($curpassword);
            ...
            $sql = "SELECT * from `itlabexercise` WHERE `username`='$username' AND  `PASSWORD`='$psw' ";
             ...
             if($num == 1){
                ...
                $update = "UPDATE `itlabexercise` SET `password` = '$hasspass' WHERE `itlabexercise`.`username` = '$username'";
...
<div class="container">  
        <div class="center">
            ...
            <form action="/corona/resetpassword.php" method="post">
                <div class="user">
