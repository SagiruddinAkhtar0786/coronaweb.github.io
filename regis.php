...
//    echo ($password);
    ...
    $existsql = "SELECT * FROM `itlabexercise` WHERE username = '$username'";
    // echo($existsql);
    ...
    if($numexistrows == 1){
        ...
        // echo("else");
            ...
            $sql = "INSERT INTO `itlabexercise` (`username`, `password`, `phonenumber`, `reg_date`) VALUES ('$username', '$psw', '$phonenumber', current_timestamp())";
            //  ech o($sql);
